...
ggsave(
  filename = file.path(plotFolder, paste0("sup_sensitivityAnalysis.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,         
  height   = 2.3,          
...
ggsave(
  filename = file.path(plotFolder, paste0("sup_countryComparisonAMb.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,         
  height   = 2.3,          
...
ggsave(
  filename = file.path(plotFolder, paste0("sup_countryComparisonViableActivity.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,         
  height   = 2.3,          
