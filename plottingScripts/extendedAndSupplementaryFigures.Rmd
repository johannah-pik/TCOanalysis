...
ggsave(
  filename = file.path(plotFolder, paste0("sensitivityAnalysis.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,         
  height   = 2.3,          
...
ggsave(
  filename = file.path(plotFolder, paste0("countryComparisonAMb.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,         
  height   = 2.3,          
...
ggsave(
  filename = file.path(plotFolder, paste0("countryComparisonViableActivity.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,         
  height   = 2.3,          
