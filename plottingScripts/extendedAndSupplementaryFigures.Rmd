---
title: "Extended and supplementary figures"
...
# Extended Fig. A1 | Heterogeneous DCO of BETs against ICETs for feasible maximum daily mileages, and their respective cumulative share of vehicles.
...
ggsave(
  filename = file.path(plotFolder, paste0("FigA1.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,          
  height   = 6.2/3,          
...
# Extended Fig. A2 | Economically viable HDV road freight activity for the optimistic, medium, and pessimistic DCO scenario comparing BETs with FCETs.
...
ggsave(
  filename = file.path(plotFolder, paste0("FigA2.pdf")),
  plot     = plotWithLabels,
  device   = cairo_pdf,
  width    = 4.5,          
  height   = 5.5,          
...
# Extended Fig. A3 | Assumptions on evolution of fast-charging infrastructure availability over time
...
ggsave(
  file.path(plotFolder, "FigA3.pdf"),
  plot = infraPlot,
  device   = cairo_pdf,
  width    = 3,          
  height   = 1.5,          
